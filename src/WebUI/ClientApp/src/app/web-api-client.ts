...
export class BlogClient implements IBlogClient {
    ...
    getBlogsWithPagination(pageNumber: number | undefined, pageSize: number | undefined): Observable<BlogBreifDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetBlogsWithPagination(response_);
...
export class BlogBreifDto implements IBlogBreifDto {
    ...
    constructor(data?: IBlogBreifDto) {
        if (data) {
    ...
    static fromJS(data: any): BlogBreifDto {
        data = typeof data === 'object' ? data : {};
        let result = new BlogBreifDto();
        result.init(data);
        return result;
    }
...
export interface IBlogBreifDto {
    id?: number;
    title?: string | undefined;
    body?: string | undefined;
    creationDate?: Date;
